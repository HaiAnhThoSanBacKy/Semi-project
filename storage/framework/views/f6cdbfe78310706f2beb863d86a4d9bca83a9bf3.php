...
<div class="col-lg-4 col-md-8 col-12 mx-auto mt-5">
    <div class="card z-index-0 fadeIn3 fadeInBottom">
        ...
        <div class="card-body">
            <form class="text-start" method="POST" action="<?php echo e(route('login.post')); ?>">
...
<?php echo $__env->make('layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\semiproject\semiprojectwebqlsv\resources\views/login.blade.php ENDPATH**/ ?>