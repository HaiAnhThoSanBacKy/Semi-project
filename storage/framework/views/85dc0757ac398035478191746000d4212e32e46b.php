...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('https://fpt.edu.vn/Content/images/assets/Logo-Btec.png')); ?>">
    <title>
        FAP Btec student
    </title>
    <!-- Fonts and icons -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?php echo e(route('index')); ?>">
                <img src="<?php echo e(asset('https://fpt.edu.vn/Content/images/assets/Logo-Btec.png')); ?>" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <ul class="navbar-nav mb-3">
            <?php if(!auth()->check()): ?>
            <li class="nav-item">
                <a class="dropdown-divider" href="<?php echo e(route('login')); ?>">
            ...
            <?php else: ?>
            <li class="nav-item">
                <a class="dropdown-divider" href="<?php echo e(route('logout')); ?>">
                    <span class="dropdown-item">
                        Logout
                    </span>
                </a>
...
<?php /**PATH C:\xampp\htdocs\semiproject\semiprojectwebqlsv\resources\views/layout/base.blade.php ENDPATH**/ ?>